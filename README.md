...
- <img src="https://paidsync.ai/apple-touch-icon.png" height="14"/> [PaidSync](https://github.com/PaidSync/paidsync-mcp) - Hosted MCP server with 309 tools for running paid media with AI. Full read+write on Google Ads, Meta Ads, LinkedIn Ads, TikTok Ads, GTM, GA4, and Google Merchant Center, plus read on Google Search Console. Every write defaults to draft-preview-confirm. Works with Claude, ChatGPT, Cursor, Windsurf, Codex.
<br />
